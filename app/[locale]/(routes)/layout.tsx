...
export default async function AppLayout({
  ...
  const translations = {
    ...
    crm: {
      ...
      dashboard: dict("crm.dashboard"),
      myDashboard: dict("crm.myDashboard"),
      overview: dict("crm.overview"),
    ...
    campaignsAll: dict("campaignsAll"),
    campaignsTemplates: dict("campaignsTemplates"),
    campaignsTargets: dict("campaignsTargets"),
    campaignsTargetLists: dict("campaignsTargetLists"),
    projects: dict("projects"),
    emails: dict("emails"),
    reports: dict("reports"),
    reportsDashboard: "Дашборд",
    reportsSales: "Продажи",
    reportsLeads: "Лиды",
    reportsAccounts: "Компании",
    reportsActivity: "Активность",
    reportsCampaigns: "Кампании",
    reportsUsers: "Пользователи",
